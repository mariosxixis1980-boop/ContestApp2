...
// ✅ ΣΩΣΤΟ Logout (Supabase signOut + clear + redirect)
...
const __lb = document.getElementById("logoutBtn");
if (__lb) __lb.addEventListener("click", (e) => { e.preventDefault(); hardLogout(); });
